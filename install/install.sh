...
echo ""
echo "  Tính năng Co-work (AI sửa code) cần coworker_host chạy riêng:"
echo "    bash $PROJECT_DIR/coworker_host/run.sh"
echo "    (xem install/coworker_host.service.template để chạy như systemd service)"
echo "─────────────────────────────────────────────"
